...
public class NPC_test {
    ...
    private void addEntityToWorld(org.bukkit.World world) {
        try {
            Object nmsWorld = WorldServer;
            Method addEntity = nmsWorld.getClass().getSuperclass().getMethod("addEntity", EntityPlayerClass.getSuperclass().getSuperclass().getSuperclass(), CreatureSpawnEvent.SpawnReason.class);
            addEntity.invoke(nmsWorld, EntityPlayer, CreatureSpawnEvent.SpawnReason.CUSTOM);
    ...
    public NPC_test(String name, Location loc, String skin) {
        try {
            this.skin = skin;
            this.name = name;
            this.loc = loc;
    ...
    public NPC_test(String name, Location loc) {
        this(name, loc, name);
    }
