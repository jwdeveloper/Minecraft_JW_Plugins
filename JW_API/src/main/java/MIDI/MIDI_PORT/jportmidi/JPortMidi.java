...
import MIDI.MIDI_PORT.jportmidi.JPortMidiApi.*;
...
public class JPortMidi {
    ...
    private static MIDI.MIDI_PORT.jportmidi.JPortMidiApi pm;
    ...
    public JPortMidi() throws MIDI.MIDI_PORT.jportmidi.JPortMidiException {
        if (pmRefCount == 0) {
            pm = new MIDI.MIDI_PORT.jportmidi.JPortMidiApi();
            pmRefCount++;
