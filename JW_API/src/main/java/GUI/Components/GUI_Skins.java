...
public final class GUI_Skins {
        ...
        static {
            Bukkit.getScheduler().scheduleSyncRepeatingTask(Bukkit.getPluginManager().getPlugins()[0], CACHE::clear, 0L, 20L * 1800); // Will clear the cache every 30 minute
        }
      ...
      /*  public static String getTexture(ItemStack item) {
        ...
        public static ItemStack fromUniqueId(UUID uuid) {
            ItemStack item = new GUI_Itemstack(Material.PLAYER_HEAD);
      ...
      /*  public static ItemStack fromUrl(String url) {
            ...
            ItemStack head = new GUI_Itemstack(Material.PLAYER_HEAD);
